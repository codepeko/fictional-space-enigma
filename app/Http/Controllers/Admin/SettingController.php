...
class SettingController extends Controller
{
    public function edit()
    {
        ...
        return view('admin.settings.index', compact('settings', 'popular_syntaxes', 'syntaxes'))->with('page_title', 'Settings');
    }
    ...
    public function update(Request $request)
    {
        ...
        if ($request->type == 'general') {
            $validator = Validator::make($request->all(), [
                ...
                'kodonizle_description_site_name' => 'required|min:2|max:50',
            ...
            Setting::where('key', 'kodonizle_description_site_name')->update(['value' => $request->kodonizle_description_site_name]);
            ...
            Setting::where('key', 'ad_block_detection')->update(['value' => htmlentities($request->ad_block_detection)]);
            ...
            Setting::where('key', 'kodonizle_description')->update(['value' => $request->kodonizle_description]);
            Setting::where('key', 'kodonizle_description_keywords')->update(['value' => $request->kodonizle_description_keywords]);
