...
class PasteController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.pastes.create', compact('syntaxes', 'popular_syntaxes','paste'))->with('page_title', 'Pastes');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.pastes.edit', compact('paste', 'syntaxes', 'popular_syntaxes','folders'))->with('page_title', 'Pastes');
    }
